            ...
            if str(sys.argv[2]) == '1':
                if not len(sys.argv) == 12:
                    ...
                    print(
                        "-------------------------------------------------------------------------------------")
                    print(
                        "Example: python calculate_path_distance.py /move_base/GlobalPlanner/plan 1 0 1.0 -0.65 2.0 -1.307 100 37.42 0 0")
                    print(
                        "-------------------------------------------------------------------------------------")
                    print(
