var Joystick_info = function (container, parameters) {
  this.GetX = function () {
...
function drawjoystick_base() {
  ...
  joy_ctx.lineWidth = 1;
  joy_ctx.arc(
    joystick_canvas.width / 2,
    joystick_canvas.height / 2,
    Round_r,
    0,
    2 * Math.PI
  );
  joy_ctx.moveTo(
    joystick_canvas.width / 2,
    joystick_canvas.height / 2 - Round_r
  );
  joy_ctx.lineTo(
    joystick_canvas.width / 2,
    joystick_canvas.height / 2 + Round_r
  ...
  joy_ctx.moveTo(
    joystick_canvas.width / 2 - Round_r,
    joystick_canvas.height / 2
  );
  joy_ctx.lineTo(
    joystick_canvas.width / 2 + Round_r,
...
joystick_canvas.addEventListener("mousedown", function (e) {
  ...
  if (e.button == 0) {
    ...
    if (checkArea() == 1) {
      ...
      if (radius >= Round_r) radius = Round_r;
      joy_ctx.beginPath();
